...
BringEnemy = function()
	...
	for _, it in ipairs(list) do
        ...
        local offsets = {
            Vector3.new(1.5, 0, 0),   -- Direita
            Vector3.new(-1.5, 0, 0),  -- Esquerda
            Vector3.new(0, 0, 1.5),   -- Frente
            Vector3.new(0, 0, -1.5)   -- Trás
        }
        local currentOffset = offsets[((_ - 1) % #offsets) + 1]
        local targetCF = CFrame.new(PosMon + currentOffset)
